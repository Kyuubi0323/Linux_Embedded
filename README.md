...
sync
```
After that, u can config usb port to connect internet without using Ethernet port. Control your board by the computer with Serial connection (rcm using CP2102 TTL series).
